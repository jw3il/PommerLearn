...
void MCTSCrazyAraAgent::init_state(bboard::GameMode gameMode, bboard::ObservationParameters observationParameters, uint8_t valueVersion, PlanningAgentType planningAgentType)
{
    CrazyAraAgent::init_state(gameMode, observationParameters, valueVersion, planningAgentType);
