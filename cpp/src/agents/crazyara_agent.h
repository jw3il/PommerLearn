...
public:
     ...
     * @param observationParameters How this agent and its opponents observe the state
     ...
     */
    virtual void init_state(bboard::GameMode gameMode, bboard::ObservationParameters observationParameters, uint8_t valueVersion=1, PlanningAgentType planningAgentType=PlanningAgentType::None);
...
public:
    ...
    // CrazyAraAgent
    void init_state(bboard::GameMode gameMode, bboard::ObservationParameters observationParameters, uint8_t valueVersion, PlanningAgentType planningAgentType=PlanningAgentType::None) override;
    bool has_stateful_model() override;
    crazyara::Agent* get_acting_agent() override;
    NeuralNetAPI* get_acting_net() override;
};
